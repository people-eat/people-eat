import { PriceClass, toTranslatedFormattedDate, translatedPriceClasses } from '@people-eat/web-domain';
...
export function GlobalBookingRequestRow({ occasion, priceClass, dateTime, onSelect }: GlobalBookingRequestRowProps) {
    return (
        <li className="relative py-5 hover:bg-gray-50" role="button" onClick={onSelect}>
