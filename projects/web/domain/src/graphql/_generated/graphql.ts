...
export type ChatMessageFragment = { __typename?: 'ChatMessage', chatMessageId: string, bookingRequestId: string, message: string, createdBy: string, createdAt: Date };
...
export type BookingRequestChatMessageCreationsSubscription = { __typename?: 'Subscription', bookingRequestChatMessageCreations: { __typename?: 'ChatMessage', chatMessageId: string, bookingRequestId: string, message: string, createdBy: string, createdAt: Date } };
