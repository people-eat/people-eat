...
export type AdminGetCooksPageDataQuery = { __typename?: 'Query', cooks: { __typename?: 'CookQuery', findMany: Array<{ __typename?: 'Cook', cookId: string, isVisible: boolean, city: string, user: { __typename?: 'User', firstName: string, lastName: string, profilePictureUrl?: string | null }, visitStatistics: { __typename?: 'CookVisitStatistics', visitCountTotal: number, visitCountLastWeek: number, visitCountLastMonth: number } }> } };
