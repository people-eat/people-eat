        ...
        <div>
            ...
            <div className="mt-2">
                ...
                <textarea
                    placeholder={placeholder}
                    rows={4}
                    className="block w-full rounded-2xl border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6 max-h-44"
                    defaultValue=""
                    ref={ref}
                    {...rest}
                />
