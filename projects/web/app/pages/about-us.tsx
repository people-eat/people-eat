                            ...
                            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
                                ...
                                <div className="max-w-xl">
                                    <p className="mt-6">
                                        ...
                                        <br />
                                        <br />
                                        Alles begann, als Natalia vor ihrem Auszug aus ihrer Wohnung in Mannheim stand und sich Daniel dazu
                                        entschloss, dieses besondere Ereignis mit einem Abendessen, zubereitet von einem Koch, zu feiern.
                                        Als Daniel sich auf die Suche nach einem Koch machte, wurde schnell klar, dass es gar nicht so
                                        einfach ist, einen Koch in der Umgebung zu finden. So wurde die Suche zu eine überraschenden
                                        Herausforderung. Nach stundenlanger Suche fand sich schließlich ein verfügbarer Koch in München, der
                                        bereit war, die 3.5 Stunden Fahrt nach Mannheim auf sich zu nehmen. Als der Koch ankam, wurden alle
                                        Erwartungen übertroffen. Natalia und Daniel konnten die Kulinarik neu für sich entdecken, genießen
                                        und einzigartige Einblicke in die Arbeit eines Kochs erhalten. An diesem Abend wurde nicht nur der
                                        Grundstein für PeopleEat gelegt, sondern auch die klare Vision, Menschen den Zugang zu erstklassigen
                                        Köchen zu ermöglichen und unvergessliche Momente mit ihren Lieben zu schaffen.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 py-20 mt-8">
                <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
                    ...
                    <p className="mx-auto mt-6 max-w-4xl text-lg leading-8 text-gray-300">
                        ...
                        Zugang zu erstklassigen Köchen ermöglichen und unvergessliche kulinarische Erlebnisse schaffen. Wir haben uns zum
                        Ziel gesetzt, die Freude am Essen und die Bedeutung von besonderen Anlässen im Leben zu feiern, indem wir
